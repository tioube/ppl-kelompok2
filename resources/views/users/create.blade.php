        ...
        <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <form action="{{ route('users.store') }}" method="POST" class="p-6">
                ...
                <div class="mt-6 border-t border-gray-200 pt-6 dark:border-gray-800">
                    <h4 class="mb-4 text-lg font-semibold text-gray-800 dark:text-white">Role Assignment</h4>
                    ...
                    <div>
                        <label class="mb-3 block text-sm font-medium text-gray-700 dark:text-gray-300">Direct Permissions (Optional)</label>
