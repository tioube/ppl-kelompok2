                        ...
                        <div class="mt-6 space-y-4">
                            <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-4">
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <h4 class="text-sm font-medium text-green-800 dark:text-green-300">Hierarchical Permissions</h4>
                                        <div class="mt-1 text-sm text-green-700 dark:text-green-400">
                                            <p>When you grant a parent permission (e.g., "Manage Users"), all related child permissions (View, Create, Edit, Delete Users) are automatically included. You don't need to select child permissions individually.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-6 space-y-4">
                                                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
                                                        <div class="flex">
                                                            ...
                                                            <div class="ml-3">
                                                                <h4 class="text-sm font-medium text-blue-800 dark:text-blue-300">Hierarchical Revocation</h4>
                                                                <div class="mt-1 text-sm text-blue-700 dark:text-blue-400">
                                                                    <p>When you revoke a parent permission (e.g., "Manage Users"), all related child permissions (View, Create, Edit, Delete Users) will also be blocked automatically. This ensures consistent access control.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="flex">
                                                            ...
                                                            <div class="ml-3">
                                                                ...
                                                                <div class="mt-1 text-sm text-red-700 dark:text-red-400">
                                                                    <p>Revoked permissions will deny access even if the user has the permission through their role. This overrides all other permission grants and will hide related menus.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
