        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 $stats['wajib'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-gray-500
                        <p class="text-2xl font-semibold text-gray-900 $stats['peminatan'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-gray-500 Minat</p>
                        <p class="text-2xl font-semibold text-gray-900 $stats['lintas_minat'] }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6">
            <form method="GET" class="space-y-4">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-medium text-gray-900 & Pencarian</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text"
                                   ...
                                   class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="kategori" id="kategori" class="block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="number"
                                   ...
                                   placeholder="Min"
                                   min="1" max="10"
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500">
                            <input type="number"
                                   name="max_jam"
                ...
                <div class="flex items-center justify-between pt-2">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <select name="sort" class="px-3 py-1 border border-gray-300 rounded-lg bg-white text-sm focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <select name="direction" class="px-3 py-1 border border-gray-300 rounded-lg bg-white text-sm focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="rounded-lg border border-blue-200 bg-blue-50 p-4
            <div class="flex gap-3">
                ...
                <div class="text-sm text-blue-700
                    <p class="font-semibold text-blue-800 Kurikulum Merdeka</p>
